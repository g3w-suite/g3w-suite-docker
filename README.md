...
```bash
docker build -f Dockerfile.g3wsuite.dockerfile -t g3wsuite/g3w-suite:v3.11.x --no-cache .

# OPTIONAL:
# docker build -f Dockerfile.g3wsuite-deps.ltr.dockerfile -t g3wsuite/g3w-suite-deps-ltr:v3.11.x --no-cache .
```
